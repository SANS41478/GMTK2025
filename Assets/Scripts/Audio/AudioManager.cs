...
public class AudioManager : MonoBehaviour
{
    ...
    {
        var clip = clipLoader.GetClip(clipName);
    ...
    public void SetMusicVolume(float vol) => musicPlayer.SetVolume(vol);
    public void SetSFXVolume(float vol) => sfxPlayer.SetVolume(vol);
